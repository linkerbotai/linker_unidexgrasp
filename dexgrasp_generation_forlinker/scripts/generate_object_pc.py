...
def sample_projected(_):
    ...
    print('object_code_0', object_code)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root_path', type=str, default='/media/moning/Newsmy1/from_obj_to_pc/DFCData/meshes')
    ...
    #     object_code_list.append((args, object_code))
