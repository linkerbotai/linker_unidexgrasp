...
# }
    ...
    hand_translation = exchange_translation(hand_translation)
    hand_rotation = exchange_rotation(hand_rotation)
    hand_qpos = exchange_qpos(hand_qpos)
    ...
    tta_hand_translation = exchange_translation(tta_hand_translation)
    tta_hand_rotation = exchange_rotation(tta_hand_rotation)
