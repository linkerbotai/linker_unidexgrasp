...
def load_cfg(args, use_rlg_config=False):
    # print(logdir) #logs/test/shadow_hand_grasp/ppo/ppo
    # print(cfg_train) #cfg/ppo/config.yaml
    # print(cfg_env) #cfg/shadow_hand_grasp.yaml
...
def get_args(benchmark=False, use_rlg_config=False):
    custom_parameters = [
        ...
        {"name": "--horovod", "action": "store_true", "default": False,
            "help": "Use horovod for mvec_envulti-gpu training, have effect only with rl_games RL library"},
        #不同任务类型，是什么意思。
