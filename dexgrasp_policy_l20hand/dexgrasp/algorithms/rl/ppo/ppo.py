...
class PPO:
    ...
    def run(self, num_learning_iterations, log_interval=1):
        ...
        print(current_obs.shape)#torch.Size([1000, 300])
        ...
        if self.is_testing:
            ...
            for it in range(self.current_learning_iteration, num_learning_iterations):
                ...
                for _ in range(self.num_transitions_per_env):
                    # print('apply_reset', self.apply_reset)#False
                    # self.apply_reset = True
                    if self.apply_reset:
                        current_obs = self.vec_env.reset()#当前观测
                        current_states = self.vec_env.get_state()#当前状态
    ...
    def update(self):
        ...
        for epoch in range(self.num_learning_epochs):
            ...
            for indices in batch:
                ...
                # Surrogate loss 替代损失，新动作替代旧动作的损失。
